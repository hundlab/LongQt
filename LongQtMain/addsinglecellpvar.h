...
class AddSingleCellPvar : public QDialog
{
    ...
    public:
        explicit AddSingleCellPvar(shared_ptr<Protocol> proto, std::pair<QString, CellPvars::IonChanParam*> parampair, QWidget *parent = 0);
        ~AddSingleCellPvar();

private:
        void updateIonChannelType();
        void setCurrentSelect(QString name, CellPvars::IonChanParam *param);
