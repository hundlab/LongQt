    ...
    ui(new Ui::ChooseGraphs)
{
    ...
    for(int i = 0;i<plot->graphCount(); i++) {
        ...
        ui->toggleButtonLayout->addWidget(chooseToggle, i/numCollums, i%numCollums);
        connect(chooseToggle,&ChooseGraphsToggle::stateChanged, [=] (bool) {
            plot->replot();
        });
    }
}

ChooseGraphs::~ChooseGraphs()
{
    delete ui;
}
