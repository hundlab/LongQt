...
bool VoltageClampModel::setData(const QModelIndex &index, const QVariant &value, int role)
{
    try {
        auto tv = this->proto->clamps().at(index.row());
        if(index.column() == 0) {
...
bool VoltageClampModel::insertRows(int row, int count, const QModelIndex &parent)
{
...
bool VoltageClampModel::removeRows(int row, int count, const QModelIndex &parent)
{
...
bool VoltageClampModel::insertColumns(int column, int count, const QModelIndex &parent)
{
    return false;
}

bool VoltageClampModel::removeColumns(int column, int count, const QModelIndex &parent)
{
    return false;
}

QModelIndex VoltageClampModel::index(int row, int column, const QModelIndex &parent) const
{
...
QVariant VoltageClampModel::headerData(int section, Qt::Orientation orientation, int role) const
{
