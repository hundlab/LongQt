...
INCLUDEPATH += ./GridEditor ./modellib ./modellib/cell ./modellib/structure ./modellib/protocol ./gui ./gui/simulaiton ./gui/graph
...
./GridEditor/lqgrideditor.ui \
    GridEditor/conductivityeditor.ui
