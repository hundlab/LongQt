...
GpbAtrialSE::GpbAtrialSE()
{
    this->Initialize();
}

GpbAtrialSE::GpbAtrialSE(GpbAtrialSE& toCopy) : Cell(toCopy) {
    this->Initialize(); 
...
void GpbAtrialSE::updatecytobuff(){
...
void GpbAtrialSE::updateJSLbuff(){
...
{
    return "Human Atrial (Grandi 2011) SE";
}
